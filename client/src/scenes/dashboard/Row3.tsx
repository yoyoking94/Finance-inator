...
const BoxHeader = lazy(() => import('@/components/BoxHeader'))
        ...
        <>
                        ...
                        <Box key={`${data[0].name}-${i}`}>
                            <PieChart width={110} height={100}>
                                <Pie stroke="none" data={data} innerRadius={18} outerRadius={35} paddingAngle={2} dataKey="value" >
                                    {data.map((_entry, index) => (<Cell key={`cell-${index}`} fill={pieColors[index]} />))} </Pie>
                            </PieChart>
            ...
            <DashboardBox gridArea="j">
                ...
                <Typography margin="0 1rem" variant="h6">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam cum repellat iusto, iure autem tempore ea ipsam corporis mollitia expedita laboriosam veniam voluptates porro iste minus in tempora ipsum rem molestias voluptatem animi adipisci possimus ab! Quas ullam, perspiciatis distinctio iste rem, nisi exercitationem similique eius est laudantium culpa! Cumque?
                </Typography>
            </DashboardBox>
        </>
    );
