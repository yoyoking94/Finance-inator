...
const Predictions = () => {
    ...
    const [isPredictions, setIsPrediction] = useState(false)
    ...
    return (
        <DashboardBox width="100%" height="100%" p="1rem" overflow="hidden">
            <FlexBetween m="1rem 2.5rem" gap='1rem'>
                ...
                <Button onClick={() => setIsPrediction((prev) => !prev)} sx={{ color: palette.grey[900], backgroundColor: palette.grey[700], boxShadow: ".1rem .1rem .1rem .1rem rgba(0,0,0,.4)" }}>Show Predicted Revenue for Next Year</Button>
            </FlexBetween>
